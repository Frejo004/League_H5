...
import { CaptainGuard } from '@/components/auth/CaptainGuard'
...
const ScoreboardPage         = lazyPage(() => import('@/pages/ScoreboardPage'), 'ScoreboardPage')
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/scoreboard/:idOrSlug',      element: <ScoreboardPage /> },
      ...
      // ── Routes authentifiées (tous rôles y compris spectateurs approuvés) ─
      {
      ...
      // ── /captain — uniquement capitaines et administrateurs ───────────────
      {
        element: <CaptainGuard />,
        children: [
          {
            element: <AppLayout />,
            children: [
      ...
      // ── /rules-public — joueurs, capitaines et admins (pas les spectateurs) ─
      {
